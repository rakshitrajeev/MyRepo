...
insert into ATTENDEE values(1,'attendee 1','wdw');
insert into ATTENDEE values(2,'attendee 2','wdw'));
insert into ATTENDEE values(3,'attendee 3','wdw'));
insert into ATTENDEE values(4,'attendee 4','wdw'));
insert into ATTENDEE values(5,'attendee 5','wdw'));
insert into ATTENDEE values(6,'attendee 6','wdw'));
insert into ATTENDEE values(7,'attendee 7','wdw'));
insert into ATTENDEE values(8,'attendee 8','wdw'));
insert into ATTENDEE values(9,'attendee 9','wdw'));
insert into ATTENDEE values(10,'attendee 10','wdw'));
insert into ATTENDEE values(11,'attendee 11','wdw'));
insert into ATTENDEE values(12,'attendee 12','wdw'));
